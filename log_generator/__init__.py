...
from log_generator.es_handler import es_add_document, es_get_index_shard_number, es_config_wait_activ_shard
...
def check_arguments(args: dict):
    ...
    if args["esapiip"] != "":
        ...
        es_config_wait_activ_shard(args["esapiip"], es_get_index_shard_number(args["esapiip"]))
